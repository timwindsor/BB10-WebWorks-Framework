...
function enableWhitelisting() {
    ...
    accessElements.forEach(function (element, index, array) {
        ...
        qnx.callExtensionMethod('webview.addOriginAccessWhitelistEntry', 1, '*', uri, element.allowSubDomain); 
        console.log("qnx.callExtensionMethod('webview.addOriginAccessWhitelistEntry', 1, '*', " + uri + ", " + element.allowSubDomain + ");");
        qnx.callExtensionMethod('webview.addOriginAccessWhitelistEntry', 1, 'local://', uri, element.allowSubDomain); 
        console.log("qnx.callExtensionMethod('webview.addOriginAccessWhitelistEntry', 1, 'local://', " + uri + ", " + element.allowSubDomain + ");");
        if (element.features) {
            //Likely unnecessary since we substitute.
            qnx.callExtensionMethod('webview.addOriginAccessWhitelistEntry', 1, uri, 'http://localhost:8472/', true);
            console.log("qnx.callExtensionMethod('webview.addOriginAccessWhitelistEntry', 1, " + uri + ", 'http://localhost:8472/', true);");
        }
    });
}
