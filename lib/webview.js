...
var request = require('./request'),
    dialog = require('./dialog/index.js'),
    CHROME_HEIGHT = 0,
    webview,
    _webviewObj;
...
webview =
    ...
    create: function (ready) {
            //Create an out of process webview with the line below, allows blocking and other
            // features we need in the client webview.
        var options = { processType: 1};
        _webviewObj = window.qnx.webplatform.createWebView(options, function () {
            ...
            /* Catch and trigger our custome HTML dialog */
