...
webview = 
    ...
    create: function (ready, configSettings) {
        ...
        _webviewObj = window.qnx.webplatform.createWebView(function () {
            ...
            //TODO: Move this into webplatform code
            qnx.callExtensionMethod("webview.setEnableNetworkResourceRequestedEvents", _webviewObj.id, true);
            window.qnx.webplatform.getApplicationWindow().visible = true;

            _requestInst = request.init({webview: _webviewObj});
            _webviewObj.onNetworkResourceRequested = _requestInst.networkResourceRequestedHandler;
